const CACHE='central-guincho-pwa-v19';
const ASSETS=['/','/index.html','/app.css','/app.js','/owner-dashboard.css','/owner-dashboard.js','/test-mode-visibility.js','/manifest.webmanifest','/icon.svg'];
