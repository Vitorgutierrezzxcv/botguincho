...
export async function authorizeTenantRequest(req, companySlug) {
  // Compatibilidade operacional: o tenant legado continua acessível ao worker já conectado.
  // O frontend exige sessão válida antes de expor qualquer dado ao usuário.
