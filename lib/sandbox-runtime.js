...
async function startWorkerDetached(sandbox) {
  ...
  // O mkdir funciona como lock atômico dentro do próprio Sandbox. Isso impede que
  // duas Functions iniciem dois Chromium ao mesmo tempo e causem spawn ETXTBSY.
